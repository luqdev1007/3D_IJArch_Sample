namespace Assets._Project.Develop.Runtime.Gameplay.EntitiesCore
{
	public partial class Entity
	{
		...
		public Assets._Project.Develop.Runtime.Gameplay.Features.Attack.InstanShootingDirections InstanShootingDirectionsC => GetComponent<Assets._Project.Develop.Runtime.Gameplay.Features.Attack.InstanShootingDirections>();

		public Assets._Project.Develop.Runtime.Gameplay.Features.Attack.Shoot.InstantShootingDirectionArgs InstanShootingDirections => InstanShootingDirectionsC.Value;

		public bool TryGetInstanShootingDirections(out Assets._Project.Develop.Runtime.Gameplay.Features.Attack.Shoot.InstantShootingDirectionArgs value)
		{
			bool result = TryGetComponent(out Assets._Project.Develop.Runtime.Gameplay.Features.Attack.InstanShootingDirections component);
			if(result)
				value = component.Value;
			else
		...
		public Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity AddInstanShootingDirections(Assets._Project.Develop.Runtime.Gameplay.Features.Attack.Shoot.InstantShootingDirectionArgs value)
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.Attack.InstanShootingDirections() {Value = value}); 
		}
